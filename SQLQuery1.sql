...
CREATE TABLE Books (
    ...
    CONSTRAINT CK_Books_PublishYear
        CHECK (PublishYear <= YEAR(GETDATE())),
...
VALUES
(N'Harry Potter and the Philosopher''s Stone', N'9780747532699', 1997, N'Fantasy', N'J.K. Rowling', 5, 5),
(N'The Hobbit', N'9780261102217', 1937, N'Fantasy', N'J.R.R. Tolkien', 4, 4),
(N'Clean Code', N'9780132350884', 2008, N'Programming', N'Robert C. Martin', 3, 3),
(N'Database System Concepts', N'9780073523323', 2010, N'Database', N'Abraham Silberschatz', 2, 2),
(N'Introduction to Algorithms', N'9780262033848', 2009, N'Computer Science', N'Thomas H. Cormen', 2, 2),
(N'1984', N'9780451524935', 1949, N'Dystopian', N'George Orwell', 6, 6),
(N'To Kill a Mockingbird', N'9780061120084', 1960, N'Classic', N'Harper Lee', 4, 4),
(N'The Great Gatsby', N'9780743273565', 1925, N'Classic', N'F. Scott Fitzgerald', 3, 3);
GO
